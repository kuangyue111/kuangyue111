...
SDK/platform/drivers/src/ftm/ftm_oc_driver.o: ../SDK/platform/drivers/src/ftm/ftm_oc_driver.c
	@echo 'Building file: $<'
	@echo 'Executing target #44 $<'
	@echo 'Invoking: Standard S32DS C Compiler'
	arm-none-eabi-gcc "@SDK/platform/drivers/src/ftm/ftm_oc_driver.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "SDK/platform/drivers/src/ftm/ftm_oc_driver.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
