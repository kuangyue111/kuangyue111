...
uint8_t FlashSelfTestStatus = 0;    /*0:Õý³£   1£ºÒì³£*/
uint32_t  FLASHtimerCounter = 0;
/************************************************************************
...
//		selfTestStatus |= SELFTEST_PASS_FLASH_ECC;
		FlashSelfTestStatus = 0;
		FLASHtimerCounter++;
		if(FLASHtimerCounter > 20)
		{
			FLASHtimerCounter = 30;
			FlashSelfTestStatus = 0;
		}
	}
	else
