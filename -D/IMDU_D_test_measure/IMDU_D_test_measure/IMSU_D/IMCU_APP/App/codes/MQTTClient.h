...
enum returnCode { BUFFER_OVERFLOW = -2, FAILURE_MQTT = -1, SUCCESS_MQTT = 0 };
...
extern void TimerInit(Timer* t);
extern unsigned char TimerIsExpired(Timer* t);
extern void TimerCountdownMS(Timer*, clock_time_t timeoutMS);
extern void TimerCountdown(Timer* t, clock_time_t timeout);
extern clock_time_t TimerLeftMS(Timer* t);
...
enum SUB_MESSAGE_TOPIC_DEF
{
	SUB_MESSAGE_TOPIC01_pushdown_data = 0,
	SUB_MESSAGE_TOPIC02_pushdown_state,
	SUB_MESSAGE_TOPIC03_response_data,
//	SUB_MESSAGE_TOPIC04,
//	SUB_MESSAGE_TOPIC05,
...
extern MQTTClient gs_MqttClient;
...
extern void DealServerCmdData(MQTTClient* c);

extern unsigned char g_ucSubTopicxxIsSubed[MAX_MESSAGE_HANDLERS];
extern MessageData gs_SubMessageData[MAX_MESSAGE_HANDLERS];
