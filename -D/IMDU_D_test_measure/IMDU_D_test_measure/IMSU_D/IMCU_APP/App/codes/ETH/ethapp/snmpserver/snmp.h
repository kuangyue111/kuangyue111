...
#define SVERSION	1		/* current SNMP version		*/
#define SVERSION_V1	0		/* current SNMP version		*/
...
//Modified by hulw 090320 Support SNMP V1 & V2
#define SNVCBACK_CHARS_V1 { \
	'c', 'i', 'l', 'b', 'u', 'p', 0x06, 0x04 /* ASN1_OCTSTR */, \
	SVERSION_V1, SVERS_LEN, 0x02 /* ASN1_INT */ \
	}
extern char SNVCBACK[];
extern char SNVCBACK_V1[];
