...
char SNVCBACK_V1[] = SNVCBACK_CHARS_V1;

#define SNVCLEN 	sizeof(SNVCBACK) /* length of SNVCBACK 		*/
//Modified by hulw 090320 Support SNMP V1 & V2
#define SNVCLEN_V1 	sizeof(SNVCBACK_V1) /* length of SNVCBACK 		*/
...
mksnmp(struct req_desc *rqdp, u_char *snmppack, u_char pdutype)
{
	...
	*pp++ = pdutype;
	...
	//Modified by hulw 090320 Support SNMP V1 & V2
    extern u_char g_ucSnmpVersion;
	if(g_ucSnmpVersion == SVERSION_V1)
	{
		memcpy(pp, SNVCBACK_V1, SNVCLEN_V1);
		pp += SNVCLEN_V1;
