...
void    ISR_CIM_WWDG                     (void);
void    ISR_CIM_PVD                      (void);
void    ISR_CIM_TAMP_STAMP               (void);
void    ISR_CIM_RTC_WKUP                 (void);
void    ISR_CIM_FLASH                    (void);
void    ISR_CIM_RCC                      (void);
void    ISR_CIM_EXTI0                    (void);
void    ISR_CIM_EXTI1                    (void);
void    ISR_CIM_EXTI2                    (void);
void    ISR_CIM_EXTI3                    (void);
void    ISR_CIM_EXTI4                    (void);
void    ISR_CIM_DMA1_CH0                 (void);
void    ISR_CIM_DMA1_CH1                 (void);
void    ISR_CIM_DMA1_CH2                 (void);
void    ISR_CIM_DMA1_CH3                 (void);
void    ISR_CIM_DMA1_CH4                 (void);
void    ISR_CIM_DMA1_CH5                 (void);
void    ISR_CIM_DMA1_CH6                 (void);
void    ISR_CIM_ADC                      (void);
void    ISR_CIM_CAN1_TX                  (void);
void    ISR_CIM_CAN1_RX0                 (void);
void    ISR_CIM_CAN1_RX1                 (void);
void    ISR_CIM_CAN1_SCE                 (void);
void    ISR_CIM_EXTI9_5                  (void);
void    ISR_CIM_TIM1_BRK_TIM9            (void);
void    ISR_CIM_TIM1_UP_TIM10            (void);
void    ISR_CIM_TIM1_TRG_COM_TIM11       (void);
void    ISR_CIM_TIM1_CC                  (void);
void    ISR_CIM_TIM2                     (void);
void    ISR_CIM_TIM3                     (void);
void    ISR_CIM_TIM4                     (void);
void    ISR_CIM_I2C1_EV                  (void);
void    ISR_CIM_I2C1_ER                  (void);
void    ISR_CIM_I2C2_EV                  (void);
void    ISR_CIM_I2C2_ER                  (void);
void    ISR_CIM_SPI1                     (void);
void    ISR_CIM_SPI2                     (void);
void    ISR_CIM_USART1                   (void);
void    ISR_CIM_USART2                   (void);
void    ISR_CIM_USART3                   (void);
void    ISR_CIM_EXTI15_10                (void);
void    ISR_CIM_RTCAlarm                 (void);
void    ISR_CIM_OTG_FS_WKUP              (void);
void    ISR_CIM_TIM8_BRK_TIM12           (void);
void    ISR_CIM_TIM8_UP_TIM13            (void);
void    ISR_CIM_TIM8_TRG_COM_TIM14       (void);
void    ISR_CIM_TIM8_CC                  (void);
void    ISR_CIM_DMA1_STREAM7             (void);
void    ISR_CIM_FSMC                     (void);
void    ISR_CIM_SDIO                     (void);
void    ISR_CIM_TIM5                     (void);
void    ISR_CIM_SPI3                     (void);
void    ISR_CIM_USART4                   (void);
void    ISR_CIM_USART5                   (void);
void    ISR_CIM_TIM6_DAC                 (void);
void    ISR_CIM_TIM7                     (void);
void    ISR_CIM_DMA2_CH0                 (void);
void    ISR_CIM_DMA2_CH1                 (void);
void    ISR_CIM_DMA2_CH2                 (void);
void    ISR_CIM_DMA2_CH3                 (void);
void    ISR_CIM_DMA2_CH4                 (void);
void    ISR_CIM_ETH                      (void);
void    ISR_CIM_ETHWakeup                (void);
void    ISR_CIM_CAN2_TX                  (void);
void    ISR_CIM_CAN2_RX0                 (void);
void    ISR_CIM_CAN2_RX1                 (void);
void    ISR_CIM_CAN2_SCE                 (void);
void    ISR_CIM_OTG_FS                   (void);
void    ISR_CIM_DMA2_CH5                 (void);
void    ISR_CIM_DMA2_CH6                 (void);
void    ISR_CIM_DMA2_CH7                 (void);
void    ISR_CIM_USART6                   (void);
void    ISR_CIM_I2C3_EV                  (void);
void    ISR_CIM_I2C3_ER                  (void);
void    ISR_CIM_OTG_HS_EP1_OUT           (void);
void    ISR_CIM_OTG_HS_EP1_IN            (void);
void    ISR_CIM_OTG_HS_WKUP              (void);
void    ISR_CIM_OTG_HS                   (void);
void    ISR_CIM_DCMI                     (void);
void    ISR_CIM_CRYP                     (void);
void    ISR_CIM_HASH_RNG                 (void);
void    ISR_CIM_FPU                      (void);
...
void        BSP_LED_On_Albert                        (CPU_INT08U     led);

void        BSP_LED_Off_Albert                       (CPU_INT08U     led);

void        BSP_LED_Toggle_Albert                    (CPU_INT08U     led);
