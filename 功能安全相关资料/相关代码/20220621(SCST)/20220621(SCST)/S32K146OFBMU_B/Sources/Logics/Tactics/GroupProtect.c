...
void GroupProtectTask(void)
{
    ...
    /*有充电限制故障(仍在充电)保护检测*/
    if(((eErr_SysLim == errSort)                        /*充放电限制故障*/
    ...
    /*有电池充满电压高(仍在充电)保护检测*/
    else if(((ePRO_FULL == GetGProtectStateAPI())        /*电池组充满*/
    ...
    else if(((ePRO_EMPTY == GetGProtectStateAPI())      /*电池组充满*/
		&& (GetGCellMinVoltAPI() <= gGBmuGenPara_102[eBmuGenPara102_VH2Lim]))/*电压仍低于二级告警(电压回升不保护)*/
		&& (eCURR_DHG == GetGChgDhgStateAPI()))         /*仍在充电*/
	{
		GroupProCtrlCheck(eProSort_ChgLim);             /*检测是否保护*/
	}
    else
...
static void GroupProCtrlCheck(e_ErrProSort proSort)
{
    switch(proSort)
    {
        ...
        case eProSort_SysErr:
            ...
            if(sGProTimer[eProSort_SysErr] >= (gGBmuHigLevPara_103[eBmuHigLevPara103_ErrProOffT] * 10)) /*达到保护时间*/
            {
        ...
        case eProSort_SysPro:
            ...
            if(sGProTimer[eProSort_SysPro] >= (gGBmuHigLevPara_103[eBmuHigLevPara103_ErrProOffT] * 10)) /*达到保护时间*/
            {
                GroupProCtrlBySwitch();                                                                 /*断开相应运行接触器保护*/
        ...
        case eProSort_DhgPro:
            ...
            if(sGProTimer[eProSort_DhgPro] >= (gGBmuHigLevPara_103[eBmuHigLevPara103_DhgProOffT] * 10)) /*达到保护时间*/
            {
        ...
        case eProSort_ChgPro:
            ...
            if(sGProTimer[eProSort_ChgPro] >= (gGBmuHigLevPara_103[eBmuHigLevPara103_ChgProOffT] * 10)) /*达到保护时间*/
            {
